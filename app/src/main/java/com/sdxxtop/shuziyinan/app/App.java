package com.sdxxtop.shuziyinan.app;
...
import com.sdxxtop.shuziyinan.app.base.BaseApp;
import com.sdxxtop.shuziyinan.di.component.AppComponent;
import com.sdxxtop.shuziyinan.di.component.DaggerAppComponent;
import com.sdxxtop.shuziyinan.di.module.AppModule;
import com.sdxxtop.shuziyinan.service.ForegroundService;
...
//
//        if ("com.sdxxtop.shuziyinan:remoteweb".equals(getProcessName(this))) {
...
//        }
    ...
    private void initBaiduFace() {
        FaceSDKManager.getInstance().initialize(this, "shuziyinan-face-android", "idl-license.face-android");
    }
...
//                .logStrategy(new LogcatLogStrategy())  //（可选）更改要打印的日志策略。 默认LogCat
    ...
    private void initCloudChannel(Context applicationContext) {
        ...
        MiPushRegister.register(applicationContext, "2882303761518228103", "5471822827103");
