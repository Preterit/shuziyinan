package com.sdxxtop.shuziyinan.ui.widget;
...
public class ColorTrackTabLayout extends TabLayout {
    ...
    private ColorTrackTabLayout.ColorTrackTabLayoutOnPageChangeListener mPageChangeListenter;
    ...
    public void setupWithViewPager(@Nullable ViewPager viewPager, boolean autoRefresh) {
        ...
        try {
            ...
            Field field = TabLayout.class.getDeclaredField("pageChangeListener");
            field.setAccessible(true);
            TabLayoutOnPageChangeListener listener = (TabLayoutOnPageChangeListener) field.get(this);
            if (listener != null) {
                //删除自带监听
                viewPager.removeOnPageChangeListener(listener);
                mPageChangeListenter = new ColorTrackTabLayout.ColorTrackTabLayoutOnPageChangeListener(this);
