package com.sdxxtop.shuziyinan.ui.widget.chart;
...
//        barDataSet.setValueTextColor(color);
    ...
    public void showBarChart(List<DataBean> dateValueList, String name, int color) {
        ...
        for (int i = 0; i < dateValueList.size(); i++) {
             ...
             * 即可设置柱状图顶部的 icon展示
             */
            BarEntry barEntry = new BarEntry(i, dateValueList.get(i).value);
...
//        leftAxis.setAxis(new float[]{0f, 100f, 1000f, 10000f});
    ...
    public static class DataBean {
        ...
        public DataBean(float value, String tx) {
            this.value = value;
            this.tx = tx;
        }
